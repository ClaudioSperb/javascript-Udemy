function calculoImc(){
    ...
    form.addEventListener('submit', function(e) {
        ...
        if(imc < 18){
            resultado.innerHTML += `Seu imc é de <strong>${imc.toFixed(2)}</strong> - Você esta a baixo do peso !`
            ...
            resultado.innerHTML = `Seu imc é de <strong>${imc.toFixed(2)}</strong> - Você esta com obesidade Grau 1 !`
        } else if(imc >= 35 && imc <= 39.9){
            resultado.innerHTML = `Seu imc é de <strong>${imc.toFixed(2)}</strong> - Você esta com obesidade Grau 2 !`
        } else if(imc > 40){
            resultado.innerHTML = `Seu imc é de <strong>${imc.toFixed(2)}</strong> - Você esta com obesidade Grau 3 !`
        } else{
